...
- **Interactive File Uploads** involve :ref:`downloading template spreadsheets` that can be completed offline and uploaded to BioSamples. This may be the easier option for non-programmatic submitters.
