...
- **Interactive File Uploads** involve `downloading template ISA-TAB spreadsheets <interactively/step-by-step.html>`_ that can be completed offline and uploaded to BioSamples. This may be the easier option for non-programmatic submitters.
...
- `Updating existing samples <../update/update-samples.html>`_
